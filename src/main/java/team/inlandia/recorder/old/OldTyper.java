package team.inlandia.recorder.old;
...
public class OldTyper {

//	public void typeTest(char character) throws AWTException {
//		switch (character) {
//		case 'a':
//			doType(VK_A);
//			break;
...
//	}
	...
	public void doTypeSingle(int keyCode) throws AWTException {
//		try {
//			Thread.sleep(1500);
...
//		}
	...
	private void switchLanguage(Robot bot) {
		bot.keyPress(VK_ALT);
		...
		try {
			Thread.sleep(1000); //some delay for wait for language changed
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
	...
	// from https://stackoverflow.com/questions/1248510/convert-string-to-keyevents
...
//			doType(VK_PERIOD);
//			break;
        case '.': doTypeSingle(VK_DECIMAL); break;
		case '>':
